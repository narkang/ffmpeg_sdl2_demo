...
int main(int argc, char *argv[]) {
    ...
    strncpy(is->filename, file, sizeof(is->filename));
...
////    SDL_Surface* image = IMG_Load("C:\\Users\\Admin\\CLionProjects\\SDL2\\meinv.png");//采用image加载png格式图片
